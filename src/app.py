...
class Application:
    ...
    def set_dqn(self):
        if self.current_algorithm != 'dqn':
            self.envs, self.agents = initalize_agents(n_agents=3, resources=1000, tl_agent=2, model='trained/dqn/mdqn1000ep1000m25inc2_rf_20rps5.0alpha1000res', algorithm='mdqn', independent=False, priorities=[1.0, 1.0, 1.0])
