...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_model', type=str, default='code/model_metric_data/dqn/mdqn310ep1000m25inc2_rf_20rps5.0alpha1000res_double_dueling_pretrained?', help='Model to load')
    ...
    infer_mdqn(3, args.load_model, args.resources, args.increment, args.debug, priorities=priorities, action_interval=args.action_interval)
